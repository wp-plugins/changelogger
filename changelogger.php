 ...
 */
define("CLOS_PLUGINPATH", "/" . plugin_basename( dirname(__FILE__) ) . "/");

/**
 * Define the plugin full url
 */
define("CLOS_PLUGINFULLURL", WP_PLUGIN_URL . CLOS_PLUGINPATH );

/**
 * Define the plugin full directory
 */
define("CLOS_PLUGINFULLDIR", WP_PLUGIN_DIR . CLOS_PLUGINPATH );
